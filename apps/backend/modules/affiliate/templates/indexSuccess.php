...
<div id="sf_admin_container">
  ...
  <div id="sf_admin_content">
          <form action="<?php echo url_for('jobeet_affiliate_collection', array('action' => 'batch')) ?>" method="post" id="sf_admin_content_form">
      <?php include_partial('affiliate/list', array('pager' => $pager, 'sort' => $sort, 'helper' => $helper, 'hasFilters' => $hasFilters)) ?>
  ...
  <?php include_partial('affiliate/themeswitcher') ?>
</div>
